...
class Phpanalysis
{
    ...
    public $addonDicFile = 'Public/dict/words_addons.dic';
    ...
    public $mainDicFile = 'Public/dict/base_dic_full.dic';
    ...
    {
        //$this->addonDicFile = dirname(dirname(dirname(dirname(__FILE__)))).'/'.$this->addonDicFile;
        //$this->mainDicFile  = dirname(dirname(dirname(dirname(__FILE__)))).'/'.$this->mainDicFile;
